...
// means if a configuration is accidentally wiped on Kuber we can self-recover
// without too much hassle, so long as Kuber is aware of what servers should
// exist on it.
...
// when determining if the credentials provided to Kuber are valid.
...
// instance. This sets what Kuber is looking for to mark a server as done
